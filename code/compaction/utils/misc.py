...
import compaction.utils.multiprocessing as mpu
from compaction.datasets.utils import pack_pathway_output
from compaction.model.batchnorm_helper import SubBatchNorm3d
...
def is_eval_epoch(cfg, cur_epoch, multigrid_schedule):
    ...
    if cur_epoch + 1 == cfg.SOLVER.MAX_EPOCH:
        return True
    # if cur_epoch > cfg.SOLVER.STEPS[1] and cur_epoch < 14: # hack
    #     return True
