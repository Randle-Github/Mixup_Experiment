...
from compaction.datasets.multigrid_helper import ShortCycleBatchSampler

from . import utils as utils
from .build import build_dataset
from .samplers import RASampler, MySampler
from compaction.datasets import samplers
...
def my_construct_train_loader(cfg, seq):
    dataset_name = cfg.TRAIN.DATASET
    batch_size = int(cfg.TRAIN.BATCH_SIZE / max(1, cfg.NUM_GPUS))
    ...
    # own sampler
    sampler = samplers.MyDistributedSampler(dataset, seq, shuffle=False)
